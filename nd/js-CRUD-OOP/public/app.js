...
var OopCRUD = /*#__PURE__*/_createClass(function OopCRUD(raktas) {
  var _this = this;
  ...
  _defineProperty(this, "Store", function (type, weight) {
    var id = (0,uuid__WEBPACK_IMPORTED_MODULE_0__["default"])();
    var dataToStore = _objectSpread(_objectSpread(_objectSpread({}, type), weight), {}, {
      id: id
    });
  ...
  _defineProperty(this, "Destroy", function (id) {
    _this.list = _this.list.filter(function (element) {
...
var init = function init(_) {
  FutureObject = new _Ls_js__WEBPACK_IMPORTED_MODULE_0__["default"]('w_Ganykla_OOP');
  _render(FutureObject.list);
  var createSelect = document.querySelector('[data-create-animal-select]');
  var createInput = document.querySelector('[data-create-animal-input]');
  var createButton = document.querySelector('[data-create-animal-button]');
  createButton.addEventListener('click', function (_) {
    var animalName = createSelect.value;
    var animalWeight = createInput.value;
    var dataToStore = {
...
var _render = function render(arrayList) {
  var animalsList = document.querySelector('[data-animals-list]');
  var listRowTemplate = document.querySelector('[data-list-template]');
  animalsList.innerHTML = '';
  arrayList.forEach(function (gyvunasItem) {
    var rowHtml = listRowTemplate.content.cloneNode(true);
    var animalName = rowHtml.querySelector('[data-animal-name]');
    ...
    var editInput = rowHtml.querySelector('[data-edit-animal-input]');
    var editButton = rowHtml.querySelector('[data-edit-animal-button]');
    editInput.value = gyvunasItem.animalWeight;
    editButton.dataset.id = gyvunasItem.id;
    editButton.addEventListener('click', function (e) {
      var id = e.target.dataset.id;
      var animalWeight = editInput.value;
      var dataToUpdate = {
        animalWeight: animalWeight
      };
    ...
    animalName.innerText = "Gyv\u016Bnas: ".concat(animalSelected(gyvunasItem.animalName), ", Svoris: ").concat(gyvunasItem.animalWeight, " kg.");
...
var animalSelected = function animalSelected(gyvunas) {
  return {
    avis: 'Avis',
    antis: 'Antis',
    antilope: 'Antilopė'
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkjs_crud_oop"] = self["webpackChunkjs_crud_oop"] || [];
