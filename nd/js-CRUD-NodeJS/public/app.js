...
var render = function render(_) {
  ...
  animalsArray.forEach(function (gyvunasItem) {
...
var readLocalStorage = function readLocalStorage(_) {
  var data = localStorage.getItem(RAKTAS);
  if (null === data) {
    animalsArray = [];
  } else {
...
var writeLocalStorage = function writeLocalStorage(_) {
  var data = JSON.stringify(animalsArray);
  localStorage.setItem(RAKTAS, data);
};
var Store = function Store(type, weight) {
...
var Destroy = function Destroy(id) {
  animalsArray = animalsArray.filter(function (element) {
...
var Update = function Update(id, data) {
  animalsArray = animalsArray.map(function (item) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkjs_crud_nodejs"] = self["webpackChunkjs_crud_nodejs"] || [];
