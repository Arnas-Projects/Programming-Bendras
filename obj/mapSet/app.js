...
map.set('zveris', 'raccoon');
map.set('spalva2', 'black'); // overwritina spalvą
map.set(87, 'skaičius');
...
console.log(map.get('zveris')); // gauti meškėną. Naudojam raktą, o ne indeksą
// console.log(map[2]);
...
console.log(map.has('labas')); // ar yra elementas su tokiu raktu
...
const sortedMap = new Map(arrFromMap);
...
// neiteruojamas objektas, t.y. objektas neturintis indeksų
const obj = {
    kas: 'Malkos',
    kam: 'Krosniai',
    kodel: 'Nes šalta'
