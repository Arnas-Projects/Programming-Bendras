...
console.log(a, x, b, c); // '123' '123' '123'
console.log(typeof a, typeof x, typeof b, typeof c); // string string string
...
console.log(Number.isFinite(10/5)); // false
