...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Ls); // eksportuojam failą Ls.js
...
var FutureObject; // klasės Ls objektas (bus sukurtas)

var init = function init(_) {
  FutureObject = new _Ls_js__WEBPACK_IMPORTED_MODULE_0__["default"]('x_colorStorage-OOP'); // FutureObject.list jau atsiranda kvadratukai su spalvom
  ...
  createButton.addEventListener('click', function (_) {
    ...
    _render(FutureObject.list); // LS.list jau yra pakeistas klasėje
  });
};
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunk_034_02_crud_with_oop"] = self["webpackChunk_034_02_crud_with_oop"] || [];
