...
console.log('Labas, JavaScriptai');
...
// 160px ====> '160px' nes be kabučių būtų kintamojo vardas arba skaičius, o ne reikšmė
...
let myH2Second = document.querySelector('h2 + h2');

myH2Second.style.color = 'orange';
...
console.log(++funNumber); //kairėje padidina skaičių tada veiksmas

// console.log(funNumber++); //veiksmas, o tada didinimas
...
const animal1InAction1 = animal1 + '  ' + action1; // + JavaScript'e yra suklijavimas
