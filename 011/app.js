...
console.log(x, pasisveikinimasSuBarsuku); // console.log komanda yra TIK MATAVIMAS, tarsi matuotume stalo ar kėdės ilgį. Funkcionalumo tai niekaip nepakeis

let L = 20; // kintamojo deklaracija - vardo ir reikšmės suteikimas
const N = 20;

// 1. Kintamojo vardas
// 2. Kintamojo reikšmė (turinys). Example: let L - kintamasis, reikšmė: 20
// 3. Kintamojo tipas
...
// Veiksmus galime atlikti TIK SU VIENODAIS TIPAIS

let K40 = K1 + K3; // sulipdymas, Number suklijuotas su String = suklijuoja ir atvaizduoja kaip String VISADA
...
// Object tipas
let bebras = {
    vardas: 'Jonas', //čia yra savybė arba property arba trumpinys props
    amzius: 12,
}
